...
@RequestMapping("/produto") // identificador de url
...
public class ProdutoController {
    ...
    public ResponseEntity<List<ProdutoModel>> getByNome(@PathVariable String preco){
		return ResponseEntity.ok(repository.findAllbyTituloContainingIgnoreCase(preco));
	...
	@PutMapping
	public ResponseEntity<ProdutoModel>put(@RequestBody ProdutoModel preco){
		return ResponseEntity.status(HttpStatus.OK).body(repository.save(preco));
	}
	@DeleteMapping("/{id}")
